      ...
      <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
        <div className={styles.socials}>
          <a href="https://twitter.com/AllianceDAO" target="_blank" rel="noopener noreferrer">
            <TwitterIcon fill='var(--token-dark-500)' width={socialSize} height={socialSize} />
          </a>
          <a href="https://discord.gg/5QrSjPzY" target="_blank" rel="noopener noreferrer">
            <MediumIcon fill='var(--token-dark-500)' width={socialSize + 1} height={socialSize + 1} />
          </a>
          <a href="https://t.me/alliancedao" target="_blank" rel="noopener noreferrer">
            <TelegramIcon fill='var(--token-dark-500)' width={socialSize - 2} height={socialSize - 2} />
          </a>
        </div>
        <Link to="/">
